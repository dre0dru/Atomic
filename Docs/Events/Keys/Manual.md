...
The recommended approach is to define keys once in an `[EventExtensionsAPI]` class and let the generator create extension
methods:
...
- Use `[EventExtensionsAPI]` source generation for type-safe invoke/subscribe methods.
