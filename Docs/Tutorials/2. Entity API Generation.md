...
- [Entity API Source Generation](../Entities/Manual.md#-entity-api-source-generation)
- [Entity API Source Generation](../Entities/Manual.md#-entity-api-source-generation)
- [Entity API Generator](../Entities/CodeGen/EntityExtensionsAPIAttribute.md)
- [Event API Generator](../Events/CodeGen/EventExtensionsAPIAttribute.md)
...
See [Entity API Source Generation](../Entities/Manual.md#-entity-api-source-generation) if you have not configured the DLLs yet.
...
- Type-safe entity tag/value extension methods via `[EntityExtensionsAPI]`
- Type-safe event-bus extension methods via `[EventExtensionsAPI]`
